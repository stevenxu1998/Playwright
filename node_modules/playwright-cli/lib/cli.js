...
async function open(options, url, enableRecorder) {
    const { context, browserName, launchOptions, contextOptions } = await launchContext(options, false);
    new scriptController_1.ScriptController(browserName, launchOptions, contextOptions, context, process.stdout, enableRecorder, options.device);
