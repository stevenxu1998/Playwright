...
class RecorderController {
    constructor(browserName, launchOptions, contextOptions, context, output, deviceName) {
        this._pageAliases = new Map();
        this._lastPopupOrdinal = 0;
        this._timers = new Set();
        this._output = new terminalOutput_1.TerminalOutput(browserName, launchOptions, contextOptions, output, deviceName);
        ...
        context.exposeBinding('commitLastAction', (source, action) => this._output.commitLastAction()).catch(e => { });
