...
class Page extends channelOwner_1.ChannelOwner {
    ...
    _onVideoStarted(params) {
        this.emit(events_1.Events.Page._VideoStarted, video_1.Video.from(params.video));
    }
    _onClose() {
        this._closed = true;
...
class BindingCall extends channelOwner_1.ChannelOwner {
    ...
    async call(func) {
        try {
            ...
            const result = await func(source, ...this._initializer.args.map(jsHandle_1.parseResult));
