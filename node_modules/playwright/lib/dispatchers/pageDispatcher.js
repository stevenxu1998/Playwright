...
const videoDispatcher_1 = require("./videoDispatcher");
class PageDispatcher extends dispatcher_1.Dispatcher {
    constructor(scope, page) {
        ...
        page.on(page_1.Page.Events.VideoStarted, screencast => this._dispatchEvent('videoStarted', { video: new videoDispatcher_1.VideoDispatcher(this._scope, screencast) }));
    ...
    async reload(params) {
        return { response: dispatcher_1.lookupNullableDispatcher(await this._page.reload(params)) };
    }
    async goBack(params) {
        return { response: dispatcher_1.lookupNullableDispatcher(await this._page.goBack(params)) };
    }
    async goForward(params) {
        return { response: dispatcher_1.lookupNullableDispatcher(await this._page.goForward(params)) };
    }
...
class BindingCallDispatcher extends dispatcher_1.Dispatcher {
    constructor(scope, name, source, args) {
        super(scope, {}, 'BindingCall', {
            ...
            name,
            args: args.map(jsHandleDispatcher_1.serializeResult),
        });
