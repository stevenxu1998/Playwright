...
class DispatcherConnection {
    ...
    async dispatch(message) {
        const { id, guid, method, params } = message;
        const dispatcher = this._dispatchers.get(guid);
        if (!dispatcher) {
            this.onmessage({ id, error: serializers_1.serializeError(new Error('Target browser or context has been closed')) });
            return;
        }
        ...
        try {
            ...
            const result = await dispatcher[method](validated);
