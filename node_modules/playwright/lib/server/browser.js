...
class Browser extends events_1.EventEmitter {
    ...
    _videoStarted(videoId, file, pageOrError) {
        const video = new browserContext_1.Video(file);
        ...
        pageOrError.then(pageOrError => {
            ...
            if (pageOrError instanceof page_1.Page)
                utils_1.makeWaitForNextTask()(() => pageOrError.emit(page_1.Page.Events.VideoStarted, video));
        });
    }
