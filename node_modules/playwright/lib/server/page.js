...
class Page extends events_1.EventEmitter {
    ...
    async _runAbortableTask(task, timeout) {
        return progress_1.runAbortableTask(async (progress) => {
            for (const agent of instrumentation_1.instrumentingAgents)
    ...
    async screenshot(options = {}) {
        return this._runAbortableTask(progress => this._screenshotter.screenshotPage(progress, options), this._timeoutSettings.timeout(options));
    }
    async close(options) {
