...
exports.getAttributeTask = exports.innerHTMLTask = exports.innerTextTask = exports.textContentTask = exports.dispatchEventTask = exports.waitForSelectorTask = exports.throwFatalDOMError = exports.InjectedScriptPollHandler = exports.ElementHandle = exports.FrameExecutionContext = void 0;
...
class ElementHandle extends js.JSHandle {
    ...
    async scrollIntoViewIfNeeded(options = {}) {
        return this._page._runAbortableTask(progress => this._waitAndScrollIntoViewIfNeeded(progress), this._page._timeoutSettings.timeout(options));
    }
    ...
    async selectOption(elements, values, options = {}) {
        return this._page._runAbortableTask(async (progress) => {
    ...
    async screenshot(options = {}) {
        return this._page._runAbortableTask(progress => this._page._screenshotter.screenshotElement(progress, this, options), this._page._timeoutSettings.timeout(options));
    }
    async $(selector) {
