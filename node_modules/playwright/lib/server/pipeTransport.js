...
class PipeTransport {
    constructor(pipeWrite, pipeRead) {
        ...
        this._eventListeners = [
            ...
            helper_1.helper.addEventListener(pipeRead, 'error', e => debugLogger_1.debugLogger.log('error', e)),
            helper_1.helper.addEventListener(pipeWrite, 'error', e => debugLogger_1.debugLogger.log('error', e)),
        ];
