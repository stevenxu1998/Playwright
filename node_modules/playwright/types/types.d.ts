...
export interface Page {
   ...
   */
  on(event: '_videostarted', listener: (object: Object) => void): this;
   ...
   * Emitted when video recording has started for this page. The event will fire only if `_recordVideos` option is configured on the parent context.
   */
  once(event: '_videostarted', listener: (object: Object) => void): this;
   ...
   * Emitted when video recording has started for this page. The event will fire only if `_recordVideos` option is configured on the parent context.
   */
  addListener(event: '_videostarted', listener: (object: Object) => void): this;
   ...
   * Emitted when video recording has started for this page. The event will fire only if `_recordVideos` option is configured on the parent context.
   */
  removeListener(event: '_videostarted', listener: (object: Object) => void): this;
   ...
   * Emitted when video recording has started for this page. The event will fire only if `_recordVideos` option is configured on the parent context.
   */
  off(event: '_videostarted', listener: (object: Object) => void): this;
   ...
   * Emitted when video recording has started for this page. The event will fire only if `_recordVideos` option is configured on the parent context.
   */
  waitForEvent(event: '_videostarted', optionsOrPredicate?: { predicate?: (object: Object) => boolean, timeout?: number } | ((object: Object) => boolean)): Promise<Object>;
...
export interface BrowserType<Browser> {
  ...
  launchPersistentContext(userDataDir: string, options?: {
    ...
    /**
     * **experimental** If specified, recorded videos are saved into this folder. Otherwise, temporary folder is created and is deleted when browser is closed.
     */
    _videosPath?: string;

    /**
     * **experimental** Enables automatic video recording for the new page. The video will have frames with the provided dimensions. Actual picture of the page will be scaled down if necessary to fit specified size.
     */
    _recordVideos?: {
      /**
       * Video frame width.
...
export interface BrowserContextOptions {
  ...
  /**
   * **experimental** Enables automatic video recording for new pages. The video will have frames with the provided dimensions. Actual picture of the page will be scaled down if necessary to fit specified size.
   */
  _recordVideos?: {
    /**
     * Video frame width.
